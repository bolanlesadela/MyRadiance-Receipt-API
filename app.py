...
def generate_receipt():
    ...
    pdf.set_text_color(160, 130, 110)
    pdf.multi_cell(0, 5, "All sales are final. For damaged or incorrect items, contact us within 48 hours of delivery. MyRadiance is not liable for delays caused by third-party courier services. Thank you for your patronage.")
    pdf.ln(10)
